// ---------------------------------------------------------------------------
// Icons — Lucide paths, all on a 24x24 viewBox.
//
// One consistent set and one consistent grid, so sizing is predictable
// everywhere: pass a Tailwind size class and every icon lines up.
//
// No emoji anywhere in the UI — emoji render differently per platform and
